    ...
    <div ref={ref} className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden bg-bimini-primary">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
        ...
        >
          ...
          >
            <span className="py-1.5 px-4 rounded-full bg-bimini-primary/80 backdrop-blur-md border border-white/20 text-sm font-medium tracking-wider uppercase text-bimini-peach shadow-lg ring-1 ring-white/10">
          ...
          <motion.p 
            ...
            className="text-lg md:text-xl text-gray-100 max-w-2xl mx-auto mb-12 font-light leading-relaxed drop-shadow-md"
          >
          ...
          >
            <button className="relative overflow-hidden px-10 py-4 bg-bimini-gold text-bimini-primary rounded-full font-semibold text-lg transition-all shadow-xl hover:shadow-2xl hover:shadow-bimini-gold/20 hover:-translate-y-1 flex items-center gap-2 group">
            ...
            <button className="px-10 py-4 bg-white/5 border border-white/30 text-white rounded-full font-medium text-lg hover:bg-white/10 transition-all backdrop-blur-md hover:-translate-y-1 hover:border-white/50">
              Explore Amenities
            </button>
          </motion.div>
        </motion.div>
