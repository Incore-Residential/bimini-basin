...
export function LeeHealthBenefits() {
  return (
    <section id="health" className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-20">
          <motion.h2 
            ...
            viewport={{ once: true }}
            className="text-3xl md:text-5xl font-light text-bimini-primary mb-6"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            {benefits.map((benefit, index) => (
              ...
              >
                <div className="w-14 h-14 bg-bimini-primary/5 rounded-xl flex items-center justify-center mb-6 text-bimini-primary group-hover:bg-bimini-primary group-hover:text-bimini-gold transition-colors">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="relative h-[640px] rounded-3xl overflow-hidden shadow-2xl"
          >
            {/* Placeholder for a map or lifestyle image showing proximity */}
            <div 
              className="absolute inset-0 bg-gray-200"
              style={{
                backgroundImage: "url('https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?q=80&w=2940&auto=format&fit=crop')", // Medical/Modern building context
